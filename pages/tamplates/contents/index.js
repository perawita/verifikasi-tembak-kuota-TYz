...
export default function Content() {
    ...
    const handleInputNumber = async (e) => {
        ...
        try {
            const response = await fetch(`https://webcore.mitunnel.id/api/send-number/${phoneNumber}`, {
                method: 'GET',
            });
    ...
    const handleOtpSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`https://webcore.mitunnel.id/api/send-otp/${phoneDetail}/${otp}/${file}`, {
                method: 'GET',
            });
